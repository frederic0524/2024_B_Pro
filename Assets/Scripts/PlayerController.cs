...
public class PlayerController : MonoBehaviour
{
    ...
    private float targetVerticalRoatation = 0;
    ...
    private bool isGrounded;                //플레이어가 땅에 있는 여부
    ...
    void HandleRotation()
    {
        ...
        else
        {
            ...
            //마우스 스크롤을 사용하려 카메라 줌 조정
            radius = Mathf.Clamp(radius - Input.GetAxis("Mouse SscrollWheel") * 5, minRadius, maxRadius);
        }
    }
